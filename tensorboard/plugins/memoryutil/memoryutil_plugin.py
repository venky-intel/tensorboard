...
# ==============================================================================
"""The TensorBoard MemoryUtil plugin."""
...
from tensorboard.plugins.memoryutil import metadata

# HTTP routes
TAGS_ROUTE = '/tags'
MEMORYUTIL_ROUTE = '/memoryutil'
...
class MemoryUtilPlugin(base_plugin.TBPlugin):
  """MemoryUtil Plugin for TensorBoard."""

  plugin_name = metadata.PLUGIN_NAME

  def __init__(self, context):
    """Instantiates MemoryUtilPlugin via TensorBoard core.
    ...
    # stored on MemoryUtilPlugin only to facilitate testing.
  ...
  def get_plugin_apps(self):
    return {
        ...
        MEMORYUTIL_ROUTE: self.memory_route,
    }
